    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Layouts">{{__("menu.General_management")}}</div>
        </a>
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="{{route('user-index')}}" class="menu-link">
              <div data-i18n="Without menu">{{__("menu.User")}}</div>
            </a>
          </li>
          <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="pages-account-settings-account.html" class="menu-link">
              <div data-i18n="Account">{{__("menu.Prepare_the_bill")}}</div>
            </a>
          </li>
          <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Authentications">{{__("menu.Account")}}</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="auth-login-basic.html" class="menu-link" target="_blank">
              <div data-i18n="Basic">{{__("menu.Infor")}}</div>
            </a>
          </li>
          <li class="menu-item">
